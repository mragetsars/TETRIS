...
void shape_generator(int shape[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES], int shape_shadow[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES], int next_shape)
{
    ...
    if(next_shape == 4){shape[4][0] = random_shape();}else{shape[4][0] = next_shape;}
    shape[4][1] = 1;
    if(shape[4][0] == 0){
            /* O_shape */
    ...
    for(int j = 0; j < 2; j++){
        for(int i = 0; i < 5; i++){
            shape_shadow[i][j] = shape[i][j];
        }
    }
}

int shift_left(int shape[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES], int shape_shadow[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES])
{
    int a_sensor = 0;
        for(int i = 0; i < 4; i++){
...
int shift_right(int shape[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES], int shape_shadow[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES])
{
    int d_sensor = 0;
        for(int i = 0; i < 4; i++){
...
int shift_down(int shape[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES], int shape_shadow[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES])
{
    int s_sensor = 0;
        for(int i = 0; i < 4; i++){
...
int space_rotate(int shape[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES], int shape_shadow[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES])
{
...
int game_updater(char game[TETRIS_SCREEN_WIDTH][TETRIS_SCREEN_HEIGHT], int shape[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES], int shape_shadow[TETRIS_SHAPE_ROWS][TETRIS_COORDINATES])
{
    
    for (int j = 0; j < 29; j++){
        for (int i = 41; i < 79; i++){
            if((i == shape_shadow[0][0])&&(j == shape_shadow[0][1])){
                game[i][j]= 32;
                game[i-1][j]= 32;
            }
            if((i == shape_shadow[1][0])&&(j == shape_shadow[1][1])){
                game[i][j]= 32;
                game[i-1][j]= 32;
            }
            if((i == shape_shadow[2][0])&&(j == shape_shadow[2][1])){
                game[i][j]= 32;
                game[i-1][j]= 32;
            }
            if((i == shape_shadow[3][0])&&(j == shape_shadow[3][1])){
                game[i][j]= 32;
                game[i-1][j]= 32;
            } 
        }
...
void print_game(char game[TETRIS_SCREEN_WIDTH][TETRIS_SCREEN_HEIGHT], int score, int next_shape)
{
    console_clear();
    for(int j = 0; j < 30; j++){
        for(int i = 0; i < 80; i++){
...
void score_delete(char game[TETRIS_SCREEN_WIDTH][TETRIS_SCREEN_HEIGHT], int score_level)
{
    char copy_game[TETRIS_SCREEN_WIDTH][TETRIS_SCREEN_HEIGHT];
    for (int j = 0; j < 29; j++){
        for (int i = 41; i < 79; i++){
